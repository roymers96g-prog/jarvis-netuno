...
import { User, ArrowRight, Cable, Activity } from 'lucide-react';
      ...
      <div className="w-full max-w-md glass-panel border dark:border-cyan-500/30 border-cyan-500/30 rounded-3xl p-8 shadow-2xl animate-slideUp relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <p className="text-slate-500 dark:text-zinc-400 text-sm mb-6 leading-relaxed">
            Configura tu perfil de Jarvis.
          </p>

          <form onSubmit={handleSubmit} className="w-full space-y-6">
            <div className="space-y-2">
               <label className="text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-zinc-500">1. Tu Nombre</label>
               <input 
                type="text" 
                value={name}
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-zinc-500">2. Tu Rol en Netuno</label>
              <div className="grid grid-cols-2 gap-3">
                 ...
                 >
                    <Cable size={24} className={profile === 'INSTALLER' ? 'text-cyan-500' : 'text-slate-400'} />
                    <span className="text-xs font-bold">INSTALADOR</span>
                 </button>
                 ...
                 >
                    <Activity size={24} className={profile === 'TECHNICIAN' ? 'text-violet-500' : 'text-slate-400'} />
                    <span className="text-xs font-bold">TÉCNICO SRV</span>
                 </button>
              </div>
            </div>
